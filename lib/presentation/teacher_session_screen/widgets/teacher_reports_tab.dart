...
class _TeacherReportsTabState extends State<TeacherReportsTab> {
  ...
  // Class Report variables
  bool _showClassReportTab = false;
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        ...
        } else if (_showClassReportTab) {
          setState(() {
            _showClassReportTab = false;
          });
        } else {
          widget.onBack?.call();
        }
                ...
                child: Center(
                  child: Text(
                    ...
                    style: GoogleFonts.plusJakartaSans(
                      fontSize: 13,
                      fontWeight: FontWeight.w600,
                      color: !_showClassReportTab ? Colors.white : AppTheme.textMuted,
                    ),
                  ),
                ),
              ),
